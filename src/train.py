...
def train(path=DATA, target="is_fraud"):
    ...
    params = dict(
        n_estimators=1000, learning_rate=.05, num_leaves=31, max_depth=6,
        min_child_samples=20, subsample=.8, subsample_freq=1,
        colsample_bytree=.8, reg_alpha=.1, reg_lambda=1.,
